...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          ZenResume saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets ZenResume apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than ZenResume, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, ZenResume
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. ZenResume is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, ZenResume intentionally only offers
  ...
  {
    question: "Q3. Who created ZenResume and why?",
    answer: (
      <p>
        ZenResume was created by{" "}
        <Link href="https://github.com/mrZAIN-ALI">Zain</Link> and designed
        by <Link href="https://www.linkedin.com/mrZain">Zain</Link> as
        ...
        that led to ZenResume, where we integrated best practices and our
        knowledge into this resume builder. Our hope is that ZenResume can help
  ...
  {
    question: "Q4. How can I support ZenResume?",
    answer: (
      <>
        <p>
          The best way to support ZenResume is to share your thoughts and
          feedback with us to help further improve it. You can send us an email
          at{" "}
          <Link href="mailto:zainali.rio@gmail.com">zainali.rio@gmail.com</Link>{" "}
          or{" "}
          <Link href="https://github.com/mrZAIN-ALI/ZenResume/issues/new">
            open an issue
          </Link>{" "}
        ...
        <p>
          Another great way to support ZenResume is by spreading the words.
          ...
          by{" "}
          <Link href="https://github.com/mrZAIN-ALI/ZenResume">
